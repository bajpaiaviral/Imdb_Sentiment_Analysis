# -*- coding: utf-8 -*-
"""Aviral - multi_hot_sentiment.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GTGnHjy03PyKq-XqdK-RYru4cUDnRo34
...
# fix random seed for reprodu/cibility
seed = 7
...
def fit(model):
    ...
    """
    # YOUR CODE HERE
    history=model.fit(x_strat, y_strat, epochs=1, batch_size=100,validation_data=(x_dev,y_dev), verbose=1)
...
word_to_id = keras.datasets.imdb.get_word_index()
list=[]
review1="another movie that i say i should have watched before  intense romantic drama  fascinating portrait of loneliness in a post digital world  amazingly original screenplay concept   colors and performance from actor  this made me stay with myself after the credits have finished  i found myself  on my own life and relationships  "
review1=review1.split()
list.append(review1)

review2="there was nothing in the story i could relate to  and maybe that is the line  between those who loved it it was disgusting"
